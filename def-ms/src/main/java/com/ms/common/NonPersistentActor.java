...
public abstract class NonPersistentActor extends UntypedActor {
    ...
    public static final FiniteDuration RESET_TIMEOUT = Duration.create(20, TimeUnit.SECONDS);
    ...
    public void onOpen() {
        System.out.println("Def NonPersistentActor Circuit Breaker is open ################################");
    }

    public void onClose() {
        System.out.println("Def NonPersistentActor Circuit Breaker is closed %%%%%%%%%%%%%%%%%%%%%%%%%%%%%");
    }

    public void onHalfOpen() {
        System.out.println("Def NonPersistentActor Circuit Breaker is half open, next message will go through $$$$$$$$$$$$$$$$$$$$$$$");
    }
