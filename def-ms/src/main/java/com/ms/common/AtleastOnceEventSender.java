...
public abstract class AtleastOnceEventSender extends UntypedPersistentActorWithAtLeastOnceDelivery {
    ...
    public void onReceiveCommand(Object message) {
        System.out.println("Def AtleastOnceEventSender received ===>" + message.toString());
        ...
        if (message instanceof EDFEvent) {
            ...
            System.out.println("Def AtleastOnceEventSender received confirmation ===>" + message.toString());
    ...
    public void onReceiveRecover(Object event) {
        System.out.println("Def AtleastOnceEventSender  recovered object.. " + event.toString());
    ...
    void updateState(Object event) {
        if (event instanceof EDFEvent) {
            ...
            System.out.println("Def AtleastOnceEventSender Confirmation ==>" + ack.getEventDeliveryId());
